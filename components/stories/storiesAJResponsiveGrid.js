...
storiesOf('AJResponsiveGrid', module).add('default', () => (
  <AJResponsiveGrid
    items={[
      <AJTextCard
        key="1"
      ...
      <AJTextCard
        ...
        content={
          <>
            Cousins came over in the morning and we watched old family videos. Other cousins came over in the afternoon
            for dinner.
          </>
        }
        action={(f) => f}
...
storiesOf('AJResponsiveGrid', module).add('custom breakpoints', () => (
  <AJResponsiveGrid
