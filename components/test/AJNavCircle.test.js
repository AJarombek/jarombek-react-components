...
describe('unit tests', () => {
  ...
  it('renders defaults', () => {
    const wrapper = shallow(
      <AJNavCircle direction="down" onClick={f=>f} />
    );
  ...
  it('renders an upwards button', () => {
    const wrapper = shallow(
      <AJNavCircle height="40px" active={true} direction="up" onClick={f=>f} />
    );
  ...
  it('renders an active button', () => {
    const wrapper = shallow(
      <AJNavCircle height="20px" active={true} direction="left" onClick={f=>f} />
    );
    expect(wrapper.find('div').hasClass(/(active)(-\d+)/)).toBe(true);
    expect(wrapper.find('div').hasClass(/(inactive)(-\d+)/)).toBe(false);
  });
  ...
  it('renders an inactive button', () => {
    const wrapper = shallow(
      <AJNavCircle height="20px" active={false} direction="right" onClick={f=>f} />
    );
